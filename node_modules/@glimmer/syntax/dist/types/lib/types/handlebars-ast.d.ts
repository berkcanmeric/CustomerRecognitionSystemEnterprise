...
export interface NodeMap {
    Program: {
        input: Program;
        output: AST.Template | AST.Block;
    };
    MustacheStatement: {
        input: MustacheStatement;
        output: AST.MustacheStatement | void;
    };
    Decorator: {
        input: Decorator;
        output: never;
    ...
    BlockStatement: {
        ...
        output: AST.BlockStatement | void;
    };
    DecoratorBlock: {
    ...
    SubExpression: {
        input: SubExpression;
        output: AST.SubExpression;
    };
    PathExpression: {
        input: PathExpression;
        output: AST.PathExpression;
    };
    StringLiteral: {
        input: StringLiteral;
        output: AST.StringLiteral;
    };
    BooleanLiteral: {
        input: BooleanLiteral;
        output: AST.BooleanLiteral;
    };
    NumberLiteral: {
        input: NumberLiteral;
        output: AST.NumberLiteral;
    };
    UndefinedLiteral: {
        input: UndefinedLiteral;
        output: AST.UndefinedLiteral;
    };
    NullLiteral: {
        input: NullLiteral;
        output: AST.NullLiteral;
    };
}
export declare type NodeType = keyof NodeMap;
export declare type Node<T extends NodeType = NodeType> = NodeMap[T]['input'];
export declare type Output<T extends NodeType> = NodeMap[T]['output'];
...
export declare type Statement = MustacheStatement | BlockStatement | DecoratorBlock | PartialStatement | PartialBlockStatement | ContentStatement | CommentStatement;
...
//# sourceMappingURL=handlebars-ast.d.ts.map